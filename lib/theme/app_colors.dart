...
class AppColors {
  ...
  /// 텍스트 — 약화 (보조 설명). 비활성(disabled)과 달리 본문 대비 AA(4.5:1)를 만족해야 한다.
  static const Color textTertiary = Color(0xFF94A3B8); // 검정 대비 약 8:1
  ...
  static const List<Color> accentLineGradient = [
    Color(0xFFFFEB00),
    Color(0xFF22D3EE),
  ];
